...
function change_theme() {
    ...
    if (current_background == 'url(/mars.jpg') {
        current_background = 'url(/space.jpg'
    } else {
        current_background = 'url(/mars.jpg'
    }
    header.style.background = current_background
    header.style.backgroundSize = 'cov'
}

let change_theme_button = document.querySelector('.switch-theme-button')
let current_background = 'url(/mars.jpg)'
